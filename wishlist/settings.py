...
DATABASES = {
    'default': {
        ...
        'HOST': '/cloudsql/wishlist-django-295900:us-central1:wishlist-db',
        'PORT': '5432'
    }
}
...
if not os.getenv('GAE_INSTANCE'):
    ...
    # If not using app engine then we can use sqlite 
    DATABASES = {
        'default': {
...
if os.getenv('GAE_INSTANCE'):
    GS_STATIC_FILE_BUCKET = 'wishlist-django-295900.appspot.com'
    STATIC_URL = f'https://storage.cloud.google.com/{GS_STATIC_FILE_BUCKET}/static/'

    GS_BUCKET_NAME = 'user-images-123'
